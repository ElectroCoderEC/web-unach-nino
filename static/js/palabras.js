...
$(document).ready(function () {
    ...
    const audioAdd = new Audio('../audio/efectos/addPalabra.wav'); // Reemplaza con tu ruta local
    const audioEdit = new Audio('../audio/efectos/editPalabra.wav'); // Reemplaza con tu ruta local
